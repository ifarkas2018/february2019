...
public class EmpSchedTaskMapper1p1 implements RowMapper<EmpSchedTaskInfo1p1> {
	...
	// ADD_ADD_TASK_SQL is a SQL query to which later I will add the task name, task date, start time, end time depending on the data the user entered in the Add Task form
